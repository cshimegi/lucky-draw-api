"""
Django settings for luckyapp project.
...
SECRET_KEY = '(c*rg)i_%!u8y6fyub_jod19x1--!8*h(yj4m!tc7gf@!!oemw'
...
WSGI_APPLICATION = 'luckyapp.wsgi.application'
